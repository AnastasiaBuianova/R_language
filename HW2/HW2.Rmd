...
Furthermore, the results of odds ratio analysis shows that the aux-verb 'doen' tends to be more in use with trans-verbs.  Cramér’s V indicated that researched two varibiales are likely to have middle-strong association. (I would count it as medium rather than small).
```
